...
Reference documentation is the map of your product.
Maps don't tell you where to go —
they describe what exists.
When reference docs include instructions ("To use this, first do X"), explanations ("This works because of Y"),
or opinions ("We recommend Z"), they become harder to scan and less trustworthy.
Users consult reference while coding;
they need facts instantly, not narratives.
