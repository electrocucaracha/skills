...
Active voice is clearer, shorter,
and more direct.
Second person ("you") makes documentation feel like guidance rather than a textbook.
Present tense for descriptions keeps language grounded.
These three conventions —
active voice, second person, present tense —
are the foundation of readable technical writing, endorsed by both Google and Microsoft style guides.
...
Passive voice, third person, future tense.
Wordy and impersonal.
...
Active voice, second person, present tense.
Half the words, twice the clarity.
...
"The log file is created automatically when the server starts."
