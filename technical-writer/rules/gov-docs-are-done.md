...
When documentation is optional, it becomes perpetually "we'll write it later."
Stripe's approach —
a feature isn't shipped until its documentation is written, reviewed,
and published —
is the single most effective way to prevent documentation debt.
They reinforce this by including documentation in engineering career ladders and performance reviews.
