...
Enterprise products serve a global audience.
Idioms, cultural references,
and region-specific assumptions exclude non-native English speakers —
often the majority of your developer community.
Simple, direct language translates better, both literally (for localization) and cognitively (for non-native readers).
