...
Each Diataxis content type serves a reader in a different mental state.
The tone must match.
A tutorial reader needs encouragement.
A reference reader needs precision.
A how-to reader needs efficiency.
Using the wrong tone creates friction —
an overly casual reference doc feels unreliable, an overly formal tutorial feels intimidating.
