...
After inventorying your docs, classify each page into its Diataxis quadrant and then map gaps.
Most documentation sets are heavy on reference (easy to generate) and light on tutorials and how-to guides (hard to write, high adoption impact).
Classification reveals the imbalance;
gap analysis tells you what's missing.
