...
Before restructuring, rewriting,
or adding documentation, catalog everything that exists.
This prevents duplicating existing content, reveals forgotten docs that may be outdated,
and gives you a baseline to measure improvement against.
Google OpenDocs audit methodology starts here.
